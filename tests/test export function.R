...
merged_data %<>% arrange(test, loc, code, rep)

merged_split <- split(merged_data, merged_data$test)


# A function that takes in the merged dataframe
# then exports a set of excel workbooks to some directory
export_test_workbooks <- function(merged_data = NULL, export_directory = NULL){
